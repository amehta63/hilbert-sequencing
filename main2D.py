...
def run_2d_model(dataset = "data/dataloader_dict22104.pth", batch_size=BATCH_SIZE, epochs=EPOCH_NUM):
    ...
    # training_data = CustomSequenceDataset(dimensions=3, datarange=100)
    ...
    if not now:
        ...
        tempsequence = seqdict['hilbert_sequences']
